...
var MyDatePicker = (function () {
    function MyDatePicker(elem, renderer, localeService, validatorService) {
        ...
        this.multiDateChanged = new core_1.EventEmitter();
    ...
    MyDatePicker.prototype.isInSelectedArray = function (date) {
        if (_.some(this.selectedDateArray, date)) {
            return true;
        }
        return false;
